...
[NOTE]
====
The project includes the Maven Wrapper (https://github.com/takari/maven-wrapper) set to use the latest version of Maven.
If Maven 3 is not locally installed, just use `./mvnw` instead of `mvn` in any of the examples to automatically install it.
====
